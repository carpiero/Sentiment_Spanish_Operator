...
from controls import df, GRUPO_dict

app = dash.Dash(__name__,
    meta_tags=[{"name": "viewport", "content": "width=device-width, initial-scale=1"}],title='Sentimiento Móvil',update_title='Cargando...')
...
def description_card():
    ...
    return html.Div(
        id="description-card",
        children=[
            html.H5("Análisis de Sentimiento"),
            html.H3("Twitter Operadores Móviles"),
            html.Div(
                id="intro",
    ...
    return html.Div(
        ...
        children=[html.Br() ,
            ...
            dcc.Dropdown(
                ...
                value=list(GRUPO_dict.keys())[:],multi=True,
            ),
            html.Br(),
            html.Br(),
            html.P("Operador"),
...
app.layout = html.Div(
    ...
    children=[
        ...
        html.Div(
            id="banner",
            className="banner",
            children=[html.Img(src=app.get_asset_url("Headersentiment.png"))],
        ),
        # Left column
        html.Div(
            id="left-column",
